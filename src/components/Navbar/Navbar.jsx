    ...
    <header>
      <nav>
        ...
        <div className="nav-content categorias">
          <label for="nav-categories"></label>
          <select id="nav-categories">
            <option value="volvo">Categorias</option>
            <option value="volvo">Destaques</option>
            <option value="saab">Eletrônicos</option>
            <option value="opel">Jóias</option>
            <option value="audi">Moda masculina</option>
          </select>
